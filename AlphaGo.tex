...
\begin{frame}{AlphaGo}{MCTS}
    \begin{center}
        ...
        \begin{itemize}
            \item $u(s,a) \propto \frac{P(s,a)}{1+N(s,a)}$
            \item $N (s,a) = \sum\limits_{i=1}^{n} 1_{s,a,i} $
            \item $V(s_L)=(1-\lambda)v_\theta(s_L) + \lambda z_L$
            \item $Q(s,a) = \frac{1}{N(s,a)}\sum\limits_{i=1}^{n} 1_{s,a,i} V(s_L)$
        \end{itemize}
    \end{center}
\end{frame}
